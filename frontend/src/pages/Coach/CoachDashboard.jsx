                ...
                {activeTab === "training" ? (
                  upcomingTraining.length === 0 ? (
                    ...
                    upcomingTraining.map((t) => (
                      <div
                        key={t._id}
                        className="list-group-item list-group-item-action border-0 p-4 d-flex align-items-center"
                      >
                        ...
                        <div className="flex-grow-1">
                          <h6 className="mb-1 fw-bold text-dark">
                            {t.title || "Regular Training Session"}
                          </h6>
                          <div className="d-flex flex-wrap gap-3 text-muted small">
                            <span>
                              <FiClock className="me-1" /> {t.startTime} -{" "}
                              {t.endTime}
                            </span>
                            <span>
                              <FiCalendar className="me-1" />
                              {moment(t.sessionDate).format("DD MMM YYYY")}
                            </span>
                          </div>
                        </div>
        ...
        <div className="col-12 col-xl-4">
          <div className="d-flex flex-column gap-4">
            ...
            <div className="card border-0 shadow-sm rounded-4 p-4">
              <h6 className="fw-bold mb-3 text-uppercase small text-muted letter-spacing-1">
                Quick Actions
              </h6>
              <div className="d-grid gap-2">
                <Link
                  to="/coach/attendance"
                  className="btn btn-outline-primary py-2 rounded-3 text-start d-flex align-items-center"
                >
                  <FiCheckSquare className="me-3" /> Mark Attendance
                </Link>
                <Link
                  to="/coach/matches"
                  className="btn btn-primary py-2 rounded-3 text-start d-flex align-items-center"
                >
              ...
              <div className="card-body px-4 pb-4">
                {topLeaves.length === 0 ? (
                  <p className="text-muted small mb-0">
                    All clear! No pending leaves.
                  </p>
                ) : (
                  topLeaves.map((l) => (
                    <div
                      key={l._id}
                      className="d-flex align-items-start mb-3 last-child-mb-0"
                    >
                      <div
                        className="bg-danger rounded-circle p-1 me-3 mt-1"
                ...
                <Link
                  to="/coach/medical"
                  className="btn btn-link btn-sm text-decoration-none p-0 mt-3 text-danger fw-bold small"
                >
            ...
            <div className="card border-0 shadow-sm rounded-4 overflow-hidden">
              ...
              <div className="card-body px-4 pb-4">
                ...
                <Link
                  ...
                  className="btn btn-link btn-sm text-decoration-none p-0 mt-2 fw-bold small"
                >
